...
getStudentplan_list_bp = Blueprint("getStudentplan_list", __name__)  # สร้าง Blueprint

# สร้าง instance ของ MongoDBConfig
db_config = getDatabase()

@getStudentplan_list_bp.route('/getStudentplan_list', methods=['POST'])
def getStudentplan_list():
    try:
